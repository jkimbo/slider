...
<body>
    ...
    <div role="main" id="main">
        <div id="flexcont" class="clearfix">
            <div class="flexslider">
                <ul class="slides">
                    ...
                    <li>
                        <img src="timthumb.php?src=img/slider/takenSheep.png&w=1500&h=500" />
                    </li>
                    <li>
                        <img src="timthumb.php?src=img/slider/wondering-sheep.png&w=1500&h=500" />
                    </li>
                </ul>
            </div>
        </div>
        <div id="mask-left" class="masks"></div>
        <div id="mask-right" class="masks"></div>
    </div>
    <footer>
